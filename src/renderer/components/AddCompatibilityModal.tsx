...
export const AddCompatibilityModal: React.FC<AddCompatibilityModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const input: CreateCompatibility = {
        sourceProductId,
        targetProductId: formState.targetProduct.id,
        relationType: formState.relationType,
        note: formState.note.trim() || null,
      };
      
      const result = await window.electronApi.compatibility.add(input);
        ...
        <div className="relative w-full max-w-lg transform rounded-lg bg-white shadow-xl transition-all">
          ...
          <form onSubmit={handleSubmit}>
            <div className="px-6 py-4 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Rechercher une référence compatible
                </label>
            ...
            <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50">
              ...
              <button
                type="submit"
                disabled={!formState.targetProduct || isSubmitting || success}
